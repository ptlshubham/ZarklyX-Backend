...
export class DebitNoteItem extends Model<
    InferAttributes<DebitNoteItem>,
    InferCreationAttributes<DebitNoteItem>
> {
    declare id: CreationOptional<string>;
    declare debitNoteId: string; // Foreign key to Debit-Note table
    ...
    static initModel(sequelize: Sequelize): typeof DebitNoteItem {
        DebitNoteItem.init(
            {
                id: {
                    type: DataTypes.UUID,
            ...
            {
                sequelize,
                modelName: "debit_note_item",
                tableName: "debit_note_item",
                timestamps: true,
                indexes: [
                    {
                        fields: ['debitNoteId'],
