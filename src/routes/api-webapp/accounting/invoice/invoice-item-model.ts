...
> {
    ...
    // Snapshot fields from Item (copied at invoice creation)
    ...
    declare tax: number | null; // Tax percentage at time of invoice
    declare cessPercentage: number | null;
    // Invoice-specific fields
    declare quantity: number;
    declare unitPrice: number; // Price at time of invoice
    ...
    static initModel(sequelize: Sequelize): typeof InvoiceItem {
        InvoiceItem.init(
            {
                id: {
                    type: DataTypes.UUID,
                ...
                tax: {
                    ...
                    allowNull: true,
                    comment: 'Tax percentage snapshot at time of invoice',
                },
                cessPercentage: {
                    type: DataTypes.DECIMAL(5, 2),
                    allowNull: true,
                    comment: 'Cess percentage snapshot at time of invoice',
                },
                quantity: {
                    type: DataTypes.DECIMAL(10, 2),
                    allowNull: false,
                    defaultValue: 1,
                    comment: 'Quantity ordered in this invoice',
                },
                unitPrice: {
                    type: DataTypes.DECIMAL(10, 2),
                    allowNull: false,
                    comment: 'Price at the time of invoice creation',
                },
                discount: {
                    type: DataTypes.DECIMAL(10, 2),
                    allowNull: true,
                    defaultValue: 0,
                    comment: 'Item-specific discount for this invoice',
                },
                taxable: {
