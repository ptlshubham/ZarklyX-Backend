...
export class PurchaseBillTdsTcs extends Model<
    InferAttributes<PurchaseBillTdsTcs>,
    InferCreationAttributes<PurchaseBillTdsTcs>
> {
    ...
    static initModel(sequelize: Sequelize): typeof PurchaseBillTdsTcs {
        PurchaseBillTdsTcs.init(
            {
                id: {
                    type: DataTypes.UUID,
            ...
            {
                sequelize,
                modelName: "purchase_bill_tds_tcs",
                tableName: "purchase_bill_tds_tcs",
                timestamps: true,
            }
        );
        return PurchaseBillTdsTcs;
    }
