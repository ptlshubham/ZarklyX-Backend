...
export default (app: Application) => {
    ...
    app.use("/instagram", require("./api-webapp/agency/social-Integration/instagram/instagram-api"));
    app.use("/social-posting", require("./api-webapp/agency/social-Integration/social-posting/social-posting-api"));
